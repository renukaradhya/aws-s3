package com.icarat.amazons3.sample.contollers;
...
import com.icarat.amazons3.sample.dto.UploadDto;
...
@Api(value = "s3 service", description = "API to support aws s3 Operation", position = 1)
public class S3serviceController {
  ...
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success"),
      @ApiResponse(code = 500, message = "Internal Server error"), @ApiResponse(code = 404, message = "NOT_FOUND") })
  ...
  public ResponseEntity<String> createBucket(@PathVariable("bucketname") String bucketName)
      throws IOException, HandleAmazonClientException, HandleAmazonServiceException, Conflict {
  ...
  public ResponseEntity<byte[]> download(@PathVariable("bucketname") String bucketName, @PathVariable("key") String key,
      @PathVariable("path") String path) throws IOException, DataNotFoundException {
  ...
  public List<S3ObjectSummary> list(@PathVariable("bucketname") String bucketName)
      throws IOException, HandleAmazonClientException, HandleAmazonServiceException {
  ...
  public ResponseEntity<List<Bucket>> listBuckets()
      throws IOException, HandleAmazonClientException, HandleAmazonServiceException, DataNotFoundException {
  ...
  public ResponseEntity<List<String>> getBucketObjectNames(@PathVariable("bucketname") String bucketName)
      throws IOException, HandleAmazonClientException, HandleAmazonServiceException, DataNotFoundException {
  ...
  public ResponseEntity<?> deleteObjectInBucket(@PathVariable("bucketname") String bucketName,
