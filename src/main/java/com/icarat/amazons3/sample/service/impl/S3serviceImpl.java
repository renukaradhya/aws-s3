...
public class S3serviceImpl implements S3service {
  ...
  /**
   * This method is to get all Buckets details in our s3.
   */
  @Override
  public List<Bucket> listAllBucketNames() throws DataNotFoundException {
    if (amazonS3Client.listBuckets().size() != 0) {
      ...
      throw new DataNotFoundException(DataNotFoundException.BUCKETS_NOT_FOUND);
    }
   ...
   */
  @Override
  public String uploadFileToSpecificBucket(String bucketName, String key, String path) throws DataNotFoundException {
  ...
  public String deleteObjectInBucket(String bucketName, String key)
    ...
    try {
      ...
      if (object != null) {
        ...
        throw new DataNotFoundException(DataNotFoundException.OBJECT_DOES_NOT_EXIST);
      }
    } catch (AmazonServiceException ase) {
      throw new HandleAmazonServiceException(ase.getMessage(), ase.getStatusCode());
    } catch (AmazonClientException ace) {
  ...
  /**
   * This method is used to download the specific object from bucket. And store into specified path and
   * returns byte[] of the object
   */
  @Override
